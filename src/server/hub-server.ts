  ...
  <main class="layout">
    <section class="controls" aria-label="Review filters">
      <div class="control-top">
        ...
        <label class="sort"><span>Sort</span><select id="sort"><option value="priority">Priority</option><option value="recent">Recent activity</option><option value="repository">Repository</option></select></label>
      </div>
